...
struct HelpCenterView: View {
  ...
  var body: some View {
    List {
      Section {
        Text(
          "Need help with imports, storage, or Premium? Send us a message and we’ll get back to you as soon as possible."
        )
        .font(.parkinsans(size: CGFloat(14), weight: .regular))
        .foregroundStyle(.secondary)
      }

      Section("Contact") {
        Link(
          destination: mailtoURL(
            subject: "Lector Help", body: "Hi Marlon,\n\nI need help with:\n\n")
        ) {
          HStack {
      ...
      Section("Tips") {
        ...
        tipRow(
          title: "Troubleshooting", subtitle: "Try closing and reopening the app after an import.")
      }
    }
