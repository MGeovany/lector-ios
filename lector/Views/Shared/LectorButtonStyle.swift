...
/// More compact version of the primary capsule button, intended for overlays/modals
/// (e.g. highlight actions) where vertical space is limited.
struct LectorCompactCapsuleButtonStyle: ButtonStyle {
  func makeBody(configuration: Configuration) -> some View {
    configuration.label
      ...
      .shadow(color: Color.black.opacity(0.30), radius: 10, x: 0, y: 7)
